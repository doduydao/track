...
if __name__ == '__main__':
    ...
    model_path_out = "results/15hits/unknown_track/model_docplex_LB_ss.lp"
    solution_path_out = "results/15hits/unknown_track/solution_LB_ss.json"
    figure_path_out = "results/15hits/unknown_track/result_LB_ss.PNG"
