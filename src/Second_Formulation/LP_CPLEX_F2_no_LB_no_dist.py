...
if __name__ == '__main__':
    ...
    model_path_out = "results/15hits/known_track/model_docplex_no_LB_no_dist.lp"
    solution_path_out = "results/15hits/known_track/solution_no_LB_no_dist.json"
    figure_path_out = "results/15hits/known_track/result_no_LB_no_dist.PNG"
